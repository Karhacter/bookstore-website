               ...
               <tr class="datarow">
                  ...
                  <td>
                     ...
                     <div class="function_style">
                        <a href="index.php?opt=post&cat=restore&id=<?= $post->id ?>" class="btn btn-sm btn-primary mx-1">
                           <i class="fa fa-undo"></i>
                        </a>
                        <a href="index.php?opt=post&cat=destroy&id=<?= $post->id ?>#" class="btn btn-sm btn-danger mx-1">
