         ...
         <div class="row">
            <div class="col-md-9">
               ...
               <div class="mb-3">
                  ...
                  <input type="text" name="link" class="form-control" value="<?= $banner->link ?>" placeholder="Nhập liên kết" />
               </div>
               <div class="mb-3">
                  <label><strong>Mô tả (*)</strong></label>
                  <textarea name="description" rows="5" class="form-control" placeholder="Nhập mô tả"><?= $banner->description ?></textarea>
               </div>
            </div>
            <div class="col-md-3">
